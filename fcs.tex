...
\begin{figure}[!ht]
  ...
  \caption{Actual Density-Scatter plots of sample F09-0939 for selected immunophenotypes of each tube.}
...
\begin{figure}[!ht]
  ...
  \caption{Actual Density-Scatter plots of sample F09-0628 for selected immunophenotypes of each tube.}
...
My contribution in Section~\ref{sec:fcs:fowtype-rchy} was to solve the problem using a dynamic algorithm, and its initial implementation in C++. The implementation then replaced the old implementation in the flowType Bioconductor repository. 
